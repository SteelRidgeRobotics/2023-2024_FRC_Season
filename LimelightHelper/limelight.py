...
def _ll_to_Pose3d(data: Sequence) -> Pose3d:
    return Pose3d(
        Translation3d(
            data[0],
            data[1],
...
def _ll_to_Pose2d(data: Sequence) -> Pose2d:
    return Pose2d(
        Translation2d(
            data[0],
            data[1],
...
class LimelightTarget_Retro:
    ...
    txp: float
    typ: float
    camera_pose_in_target_space: Pose3d
    robot_pose_in_field_space: Pose3d
    robot_pose_in_target_space: Pose3d
    target_pose_in_camera_space: Pose3d
    target_pose_in_robot_space: Pose3d
    camera_pose_in_target_space_2D: Pose2d
    robot_pose_in_field_space_2D: Pose2d
    robot_pose_in_target_space_2D: Pose2d
    target_pose_in_camera_space_2D: Pose2d
    target_pose_in_robot_space_2D: Pose2d
...
class Results:
    ...
    botpose: Pose3d
    botpose_wpired: Pose3d
    botpose_wpiblue: Pose3d

    botpose_2D: Pose2d
    botpose_wpired_2D: Pose2d
    botpose_wpiblue_2D: Pose2d
...
class Limelight:
    ...
    def json_dump(self) -> str:
        return cast(str, self.nt_table.getEntry("json").getString(""))
    ...
    @property
    def latest_results(self) -> Results:
        return self._json_to_results(self.json_dump)